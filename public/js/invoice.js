...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('invoice-component', __webpack_require__(65));
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-74dffe87"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/assets/js/components/InvoiceComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-74dffe87", Component.options)
  } else {
    hotAPI.reload("data-v-74dffe87", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(7)("70fc4fe2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-74dffe87\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./InvoiceComponent.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-74dffe87\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./InvoiceComponent.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.form-control[data-v-74dffe87] {\n  color: #788c9e;\n  border-radius: 5px;\n  height: 45px;\n  opacity: 0.6;\n}\n.input-group-addon[data-v-74dffe87] {\n  border-radius: 5px;\n  border: 0;\n}\n.input-cal[data-v-74dffe87] {\n  width: 100% !important;\n  color: #788c9e;\n  border-radius: 5px;\n\n  opacity: 0.6;\n}\n.text-ar[data-v-74dffe87] {\n  height: 44px;\n}\nselect[data-v-74dffe87] {\n  font-family: fontAwesome, Arial, sans-serif !important ;\n  font-size: 14px !important;\n  color: #788c9e !important;\n}\n.form-control-feedback[data-v-74dffe87] {\n  padding-top: 8px !important;\n}\n.has-feedback_[data-v-74dffe87] {\n  text-align: center;\n}\n.sel[data-v-74dffe87] {\n  position: absolute;\n  margin-top: -15px;\n}\n.fade-enter-active[data-v-74dffe87],\n.fade-leave-active[data-v-74dffe87] {\n  transition: opacity 0.5s;\n}\n.fade-enter[data-v-74dffe87], .fade-leave-to[data-v-74dffe87] /* .fade-leave-active below version 2.1.8 */ {\n  opacity: 0;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    invoiceSubmit: function invoiceSubmit() {
      var _this = this;
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post("/viewInvoice", formData).then(function (response) {
        _this.preloader = false;
        console.log("invoice : ", response.data);
        if (response.data.success == "success") {
          _this.costDay = _this.NumberFormatJS(response.data.bedroom.dayRoomCost);
          var dia = response.data.dayStay == 1 ? " dia, " : " dias, ";
          var hora = response.data.hourStay == 1 ? " hora" : " horas";

          _this.orders = response.data.orders;
          _this.totalStay = response.data.dayStay == 0 ? "" + response.data.hourStay + hora : response.data.dayStay + dia + response.data.hourStay + hora;

          _this.iva = _this.NumberFormatJS(response.data.iva.toString());
          _this.valueStay = _this.NumberFormatJS(response.data.valueStay.toString());
          _this.subTotal = _this.NumberFormatJS(response.data.subTotal.toString());
          _this.total = _this.NumberFormatJS(response.data.total.toString());

          _this.balanceFavor = response.data.total < 0 ? "( Balance a favor del cliente ) " : "";

          _this.advance = _this.NumberFormatJS(response.data.checkin.advance.toString());
          _this.nameClient = response.data.checkin.name;
          _this.showButtonGenerateInvoice = true;
          _this.showViewInvoice = true;
          _this.invoiceBebroom_id = _this.debroom_id;
        } else {
    ...
    listBebroomsOccupation: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                this.preloader = true;
                _context.next = 3;
                return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get("/bedroomOccupation").then(function (response) {
                  _this2.preloader = false;
                  console.log("correct bedroomOccupation : ", response.data.bedroomOccupation);
                  _this2.bedrooms = response.data.bedroomOccupation;
                }).catch(function (error) {
                  console.log("tenemos errores" + error);
                  _this2.preloader = false;
      ...
      function listBebroomsOccupation() {
        return _ref.apply(this, arguments);
      }

      return listBebroomsOccupation;
    }(),
    NumberFormatJS: function NumberFormatJS(value) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-74dffe87", module.exports)
  }
}
