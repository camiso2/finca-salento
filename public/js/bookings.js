...
Vue.component('bookings-component', __webpack_require__(56));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue2_datepicker_index_css__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue2_datepicker_locale_es__ = __webpack_require__(53);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "Bookings",
  components: { DatePicker: __WEBPACK_IMPORTED_MODULE_2_vue2_datepicker__["default"], PreloaderComponent: __WEBPACK_IMPORTED_MODULE_1__PreloaderComponent___default.a },
  props: {
    user_id: String
  },
    ...
    bookingSubmit: function bookingSubmit() {
      ...
      if (isNaN(timeEnterValidDate) || isNaN(timeGetoutValidDate) || timeGetoutValidDate === null || timeEnterValidDate === null || this.validateMinorCurrent(this.timeEnter) || this.validateMinorCurrent(this.timeGetout) || this.validateBetweenDates(this.timeEnter, this.timeGetout)) {
        Swal.fire({
          ...
          footer: "<p><b>POSIBLES ERRORES</b></p><div><ul><li>El formato de las fechas no es válido.</li><li>Las fechas deben ser mayores a la fecha actual.</li><li>La fecha de salida del cliente no puede ser menor a la de la entrada.</li></ul></div>"
        });
      } else {
        this.preloader = true;
        var data = {
